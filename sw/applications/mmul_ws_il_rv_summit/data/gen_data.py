...
C = [0 for _ in range(rows_A*cols_B)]

def matmul_flat(A, B, rows_A, cols_A, cols_B):
    """
    Multiply two matrices stored as flat lists.
    A: flat list of size rows_A * cols_A
    B: flat list of size cols_A * cols_B
    Returns: flat list of size rows_A * cols_B
    """
    C = [0] * (rows_A * cols_B)
...
C = matmul_flat(A, B, rows_A, cols_A, cols_B)
print_array("int32_t", "cpu_out", "ROWS_A*COLS_B", C)
