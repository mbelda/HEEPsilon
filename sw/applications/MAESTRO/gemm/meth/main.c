...
* @file   main.c
* @date   04/03/2025
* @brief  An application to run a GEMM matrix multiplication on CGRA.
*
*/
...
// La columna 2 requiere 8 elementos de configuracion (el maximo del kernel GEMM)
...
int main()
{
  ...
  // Iteraciones calculadas segun logica de Python
  int loopIit = (NI / 4) - 1;
  int loopJit = (NJ / 4) - 1;
  int loopKit = NK - 1;
  ...
  uint32_t first_addr_C = (uint32_t)&C[0];

  // Direcciones calculadas para el mapeo por fila/columna del CGRA
  ...
  // Llenado de buffers respetando el mapeo exacto de Python:
  
  // Col 0: [addr_A_0_0, loopIit, addr_C_2_0, addr_B_0_0, alpha, beta, NK]
  cgra_input[0][0] = addr_A_0_0;
  cgra_input[0][1] = loopIit;
  cgra_input[0][2] = addr_C_2_0;
  cgra_input[0][3] = addr_B_0_0;
  cgra_input[0][4] = ALPHA;
  cgra_input[0][5] = BETA;
  cgra_input[0][6] = NK;

  // Col 1: [addr_B_0_1, addr_A_1_0, addr_C_3_1, NK, beta, alpha, NJ]
  cgra_input[1][0] = addr_B_0_1;
  cgra_input[1][1] = addr_A_1_0;
  cgra_input[1][2] = addr_C_3_1;
  cgra_input[1][3] = NK;
  cgra_input[1][4] = BETA;
  cgra_input[1][5] = ALPHA;
  cgra_input[1][6] = NJ;

  // Col 2: [addr_C_0_2, addr_B_0_2, addr_A_2_0, loopKit, NJ, alpha, NK, beta]
  cgra_input[2][0] = addr_C_0_2;
  cgra_input[2][1] = addr_B_0_2;
  cgra_input[2][2] = addr_A_2_0;
  cgra_input[2][3] = loopKit;
  cgra_input[2][4] = NJ;
  cgra_input[2][5] = ALPHA;
  cgra_input[2][6] = NK;
  cgra_input[2][7] = BETA;

  // Col 3: [loopJit, addr_C_1_3, addr_B_0_3, addr_A_3_0, beta, NJ, alpha]
