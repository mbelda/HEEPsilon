...
Tensor *run_cnn_1d_v2(const int32_t *input_data) {
     ...
     * ==================================================== */
    {
        ...
        CSR_READ(CSR_REG_MCYCLE, &cycles_low);
        CSR_READ(CSR_REG_MCYCLEH, &cycles_high);
        printf("PERF: Conv Cycles: 0x%08X%08X\r\n", (unsigned int)cycles_high, (unsigned int)cycles_low);
        ...
        CSR_READ(CSR_REG_MCYCLE, &cycles_low);
        CSR_READ(CSR_REG_MCYCLEH, &cycles_high);
        printf("PERF: Batchnorm Cycles: 0x%08X%08X\r\n", (unsigned int)cycles_high, (unsigned int)cycles_low);
        ...
        CSR_READ(CSR_REG_MCYCLE, &cycles_low);
        CSR_READ(CSR_REG_MCYCLEH, &cycles_high);
        printf("PERF: Relu Cycles: 0x%08X%08X\r\n", (unsigned int)cycles_high, (unsigned int)cycles_low);
        ...
        CSR_READ(CSR_REG_MCYCLE, &cycles_low);
        CSR_READ(CSR_REG_MCYCLEH, &cycles_high);
        printf("PERF: Shift Cycles: 0x%08X%08X\r\n", (unsigned int)cycles_high, (unsigned int)cycles_low);
        ...
        CSR_READ(CSR_REG_MCYCLE, &cycles_low);
        CSR_READ(CSR_REG_MCYCLEH, &cycles_high);
        printf("PERF: Maxpool Cycles: 0x%08X%08X\r\n", (unsigned int)cycles_high, (unsigned int)cycles_low);
        ...
        CSR_READ(CSR_REG_MCYCLE, &cycles_low);
        CSR_READ(CSR_REG_MCYCLEH, &cycles_high);
        printf("PERF: DenseLayer Cycles: 0x%08X%08X\r\n", (unsigned int)cycles_high, (unsigned int)cycles_low);
        ...
        CSR_READ(CSR_REG_MCYCLE, &cycles_low);
        CSR_READ(CSR_REG_MCYCLEH, &cycles_high);
        printf("PERF: Sigmoid Cycles: 0x%08X%08X\r\n", (unsigned int)cycles_high, (unsigned int)cycles_low);
