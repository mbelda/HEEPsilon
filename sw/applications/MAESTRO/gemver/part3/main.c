...
void main()
{
  ...
  uint32_t first_addr_w = (uint32_t)&w[0];
  ...
  cgra_input[0][6] = first_addr_x;
  cgra_input[0][7] = first_addr_w + (12 * 4);
  ...
  cgra_input[1][4] = N;
  cgra_input[1][5] = first_addr_w + (5 * 4);
  cgra_input[1][6] = ALPHA;
  cgra_input[1][7] = 0;    // Padding
  ...
  cgra_input[2][4] = first_addr_x;
  cgra_input[2][5] = ALPHA;
  cgra_input[2][6] = first_addr_w + (10 * 4);
  cgra_input[2][7] = 0;    // Padding
  ...
  cgra_input[3][4] = first_addr_w + (3 * 4);
  cgra_input[3][5] = N;
  cgra_input[3][6] = ALPHA;
  cgra_input[3][7] = 0;    // Padding
  ...
  // CGRA Execution
  cgra_intr_flag = 0;
  cgra_set_kernel( &cgra, cgra_slot, PART3_KERNEL_ID);
