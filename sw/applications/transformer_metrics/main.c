...
int main() {
    ...
    uint64_t cgra_load = end - begin;
    printf("CGRA load: 0x%08lx%08lx\n", 
       (unsigned long)(cgra_load >> 32), (unsigned long)(cgra_load & 0xFFFFFFFF));
    ...
    uint64_t transformer_inf = end - begin;
    printf("Transformer inference: 0x%08lx%08lx\n", 
       (unsigned long)(transformer_inf >> 32), (unsigned long)(transformer_inf & 0xFFFFFFFF));
