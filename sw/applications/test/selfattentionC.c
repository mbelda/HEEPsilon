...
void compute_SingleHeadSelfAttn(SingleHeadSelfAttn* self_attn, int32_t* input, int32_t* output, int32_t* qkv, int32_t* intermediate, cgra_t * cgra, uint8_t cgra_slot) {
    ...
    computeDense(self_attn->query_layer, self_attn->pre_seq_len +3, input, self_attn->query_layer_out, cgra, cgra_slot); // 121x16x4
    computeDense(self_attn->key_layer, self_attn->pre_seq_len +3, input, self_attn->key_layer_out, cgra, cgra_slot); // 121x16x4
    computeDense(self_attn->value_layer, self_attn->pre_seq_len +3, input, self_attn->value_layer_out, cgra, cgra_slot); // 121x16x4
